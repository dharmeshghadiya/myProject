...
return [
    ...
    'ability_inserted' => 'Ability has been added successfully',

    'role_inserted' => 'Role has been added successfully',
    'role_updated' => 'Role has been update successfully',
    'role_deleted' => 'Role has been delete successfully',

    'vehicleNotAvailable_duplicate' => 'This date in already not availability',
    'vehicleNotAvailable_updated' => 'This vehicle not available updated',
    'vehicleNotAvailable_inserted' => 'This vehicle not available inserted',


    'driver_requirement_updated' => 'Driver Requirement updated',
    'driver_requirement_inserted' => 'Driver Requirement inserted',
    'driver_requirement_deleted' => 'Driver Requirement deleted',
    'withdraw_request_sent' => 'Your withdraw request sent',
    'not_available_balance' => 'You have not wallet balance for is 0',

    'payment_status_Transfer' => 'Payment Status Transfer',
    'payment_status_Transferred' => 'Payment Status Transferred',
    'error' => 'Something are wrong',


    'admin_user_inserted' => 'Admin User Inserted',
    'admin_user_updated' => 'Admin User Updated',
    'admin_user_deleted' => 'Admin User Deleted',

    'become_a_dealer_created' => 'Become A Dealer has been created successfully',
    'become_a_dealer_deleted' => 'Become A Dealer has been delete successfully',

    'become_a_dealer_status' => 'Become A Dealer Status has been changed successfully',
];
