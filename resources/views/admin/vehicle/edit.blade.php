...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h2 class="content-title mb-0 my-auto">{{ config('languageString.edit_ryde') }}
                    - {{$company_details->companies->name}} - {{ $vehicle->companyAddress->address }}</h2>
            </div>
        </div>
                    ...
                    <form method="POST" data-parsley-validate="" id="addEditForm" role="form">
                        ...
                        <div class="row row-sm">
                            ...
                            <input type="hidden" id="company_address_id" name="company_address_id"
                                   value="{{ $vehicle->company_address_id }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" name="daily_amount" id="daily_amount"
                                               ...
                                               value="{{ $vehicle->daily_amount }}" required
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" name="monthly_amount" id="monthly_amount"
                                               ...
                                               aria-label="monthly_amount" required
                            ...
                            <div class="col-12">
                                <div class="form-group mb-0 mt-3 justify-content-end">
                                    <div>
                                        ...
                                        <a href="{{ route('admin::viewRyde',[$company_details->company_id,$branch_id]) }}"
