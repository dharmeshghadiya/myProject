...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h2 class="content-title mb-0 my-auto">{{ config('languageString.edit_featured_category') }}</h2>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <textarea type="text" class="form-control"
                                                  ...
                                                  placeholder="{{ $language->name }} {{ config('languageString.name') }}" required>{{ $category->translateOrNew($language->language_code)->name }}
                                        </textarea>
                                        <div class="help-block with-errors error"></div>
                                    </div>
                                </div>
