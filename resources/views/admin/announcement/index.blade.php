...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h2 class="content-title mb-0 my-auto">{{ config('languageString.announcement') }}</h2>
                    ...
                    <div class="table-responsive">
                        <table class="table mg-b-0 text-md-nowrap" id="data-table">
                            ...
                            <tr>
                                ...
                                <th>{{ config('languageString.country_column') }}</th>
...
@section('js')
<script>
    const title = "{{ config('languageString.destroy_announcement').'?' }}";
    ...
    <script src="{{URL::asset('assets/js/custom/announcement.js')}}"></script>
@endsection
