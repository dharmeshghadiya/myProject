...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h2 class="content-title mb-0 my-auto">{{ config('languageString.add_announcement') }}</h2>
                        ...
                        <div class="row row-sm">
                            <div class="col-12">
                                <div class="form-group">
                                    <label for="Code">{{ config('languageString.country_column') }}<span
...
@endsection
@section('js')
    <script src="{{URL::asset('assets/js/custom/announcement.js')}}?v={{ time() }}"></script>
@endsection
