            ...
            <div class="nav nav-item  navbar-nav-right ml-auto">
                ...
                <div class="dropdown main-profile-menu nav nav-item nav-link">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <a class="dropdown-item" href="@if(Auth::user()->user_type=='company'){{ route('dealer::dealer.edit',[Auth::user()->id]) }}@else{{route('admin::profile')}}@endif"><i class="bx bx-user-circle"></i>Profile</a>
                        <a class="dropdown-item" href="@if(Auth::user()->user_type=='company'){{ route('dealer::dealerChangePassword') }}@else{{route('admin::password')}}@endif"><i class="bx bx-key"></i>Change Password</a>
                        @if(Auth::user()->panel_mode==2)
                            @if(Auth::user()->user_type=='company')
                                <a class="dropdown-item" href="{{ route('dealer::changeThemes',[1]) }}"><i
                        ...
                        @else
                            @if(Auth::user()->user_type=='company')
                                <a class="dropdown-item" href="{{ route('dealer::changeThemes',[2]) }}"><i
                        ...
                        @if(Auth::user()->locale=='en')
                            @if(Auth::user()->user_type=='company')
                                <a class="dropdown-item" href="{{ route('dealer::changeThemesMode',['ar']) }}"><i
                        ...
                        @else
                            @if(Auth::user()->user_type=='company')
                            <a class="dropdown-item" href="{{ route('dealer::changeThemesMode',['en']) }}"><i
