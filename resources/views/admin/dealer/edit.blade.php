                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="image">{{ config('languageString.license_expiry_date') }}<span
                                            class="error">*</span></label>
                                    @php $license_expiry_date = date('m/d/Y',strtotime($user->companies->license_expiry_date) ) @endphp
                                    <input class="form-control fc-datepicker" name="license_expiry_date"
                                           id="license_expiry_date" placeholder="MM/DD/YYYY" type="text"
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control"
                                           ...
                                           id="bank_contact_number" value="{{ $user->companies->bank_contact_number }}"
                                           required/>
                                    <div class="help-block with-errors error"></div>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control"
                                           ...
                                           id="beneficiary_name" value="{{ $user->companies->beneficiary_name }}"
                                           required/>
                                    <div class="help-block with-errors error"></div>
                                </div>
                            </div>
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="file" class="form-control dropify"
                                           name="dealer_logo"
                                           data-default-file="{{ asset($user->companies->dealer_logo) }}"
                                           id="dealer_logo"/>
                                    <div class="help-block with-errors error"></div>
                                </div>
                            </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <select id="extra_id_{{ $keys }}"
                                                        ...
                                                        <option value="0"
                                                                @if($dealer_extras[$global_extra->id]==1) selected @endif>{{ config('languageString.one_time') }}</option>
                                                        <option
                                                            value="2"
...
@section('js')
    <script>
        const is_edit = 1;
        const country_id = '';
        const country_code = '{{ $user->companies->country->country_code }}';
    </script>
