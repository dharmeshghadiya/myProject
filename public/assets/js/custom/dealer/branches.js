$(function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data.success === true) {
                        ...
                        setTimeout(function () {
                            window.location.href = APP_URL + '/branch'
                        }, 1000);
    ...
    $('.shift_two').on('click', function () {
        let toggle_id = $(this).attr('id');
        $(this).toggleClass('on');
        if ($(this).hasClass('on')) {
            $("#shift_two_start_" + toggle_id).attr('disabled', false);
            $("#shift_two_end_" + toggle_id).attr('disabled', false);
            $("#shift_two_day_value_" + toggle_id).val(1);
        } else {
            $("#shift_two_start_" + toggle_id).attr('disabled', true);
            $("#shift_two_end_" + toggle_id).attr('disabled', true);
            $("#shift_two_day_value_" + toggle_id).val(0);
        }
    })
